...
trigger4 = p2stateno != [12000,12002]
trigger4 = p2stateno != [11000,11010]
trigger5 = stateno = [1020,1023]
trigger5 = movecontact
trigger5 = p2stateno != [12000,12002]
trigger5 = p2stateno != [11000,11010]
trigger6 = statetype = S && p2movetype = H && var(40)=1 && stateno != 3050
...
trigger2 = p2stateno != [11000,11010]
trigger3 = stateno = 101 || stateno = 109
trigger4 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1018
...
trigger3 = p2stateno != [11000,11010]
trigger4 = stateno = 101 || stateno = 109
trigger5 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1023
...
trigger3 = p2stateno != [11000,11010]
trigger4 = stateno = 101 || stateno = 109
trigger5 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1021
...
trigger3 = p2stateno != [11000,11010]
trigger4 = stateno = 101 || stateno = 109
trigger5 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1022
...
trigger2 = p2stateno != [12000,12002]
trigger2 = p2stateno != [11000,11010]
trigger3 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1050
...
trigger2 = p2stateno != [12000,12002]
trigger2 = p2stateno != [11000,11010]
trigger3 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1060
...
trigger2 = p2stateno != [12000,12002]
trigger2 = p2stateno != [11000,11010]
trigger3 = statetype = S && p2movetype = H && var(40)=1 && stateno != 1070
...
trigger4 = p2stateno != [12000,12002]
trigger4 = p2stateno != [11000,11010]
trigger5 = statetype = S && movecontact && var(40)=1 && stateno != 240
...
trigger4 = p2stateno != [12000,12002]
trigger4 = p2stateno != [11000,11010]
trigger5 = statetype = S && p2movetype = H && var(40)=1 && stateno != 210
...
trigger5 = p2stateno != [12000,12002]
trigger5 = p2stateno != [11000,11010]
trigger6 = statetype = S && p2movetype = H && var(40)=1 && stateno != 400
